...
# Bash Prompt
#Make Bash Colors Easier to work with
#Foreground Colors
black='\[\e[30m\]'
red='\[\e[31m\]'
green='\[\e[32m\]'
...
export PS1="[\d-\A]\[\e[32m\][\[\e[m\]\[\e[32m\]\u\[\e[m\]\[\e[32m\]@\[\e[m\]\[\e[32m\]\h\[\e[m\]\[\e[32m\]]\[\e[m\]\[\e[31m\]\`parse_git_branch\`\[\e[m\][\[\e[33m\]\w\[\e[m\]]\`nonzero_return\`\$error\\n$ "
